  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AppHeader 
        ...
        breadcrumbs={[{ label: "Survey Insights" }]}
        notifications={[
          { id: "1", title: "Survey Response", message: "New feedback received from John Doe", type: "info", read: false },
          { id: "2", title: "Low Engagement Alert", message: "Employee satisfaction below threshold", type: "warning", read: false }
        ]}
      />
